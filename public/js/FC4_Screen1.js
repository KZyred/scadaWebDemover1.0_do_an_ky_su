...
socket.on('mqtt', async function(msg) {
    ...
    [_2B1, _2B2, _2B3, _2B4, _2B5, _2B6, _2B7, _2B8, _3PV1, _3PV2, _3PV3, _3PV4, _3PV5] = await Promise.all([
        ...
        await scanDot(obj,Tram1_2B3, "_3PV1"),
        await scanDot(obj,Tram1_2B4, "_3PV2"),
        await scanDot(obj,Tram1_2B5, "_3PV3"),
        await scanDot(obj,Tram1_2B6, "_3PV4"),
        await scanDot(obj,Tram1_2B7, "_3PV5"),
    ])
})